...
//  });
//codes
Route::post('/codigos/', 'codeController@massCreate');
Route::post('/codigos/validar/', 'codeController@validation');
Route::get('/codigos/', 'codeController@list');
//Users
Route::get('/', 'UserControl@greetings');
